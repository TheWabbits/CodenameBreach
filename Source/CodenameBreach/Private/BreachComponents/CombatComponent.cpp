...
#include "BreachComponents/CombatComponent.h"
#include "CodenameBreach/Public/Weapon/Weapon.h"
...
#include "PlayerController/PrimaryPlayerController.h"
...
void UCombatComponent::SetHUDCrosshairs(float DeltaTime)
{
	...
	Controller = Controller == nullptr ? Cast<APrimaryPlayerController>(Character->Controller) : Controller;
	if (Controller)
	{
