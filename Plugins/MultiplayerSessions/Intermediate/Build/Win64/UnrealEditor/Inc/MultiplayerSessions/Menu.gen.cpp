...
// End Cross Module References
	...
	{
		P_GET_PROPERTY(FIntProperty,Z_Param_NumberOfPublicConncetions);
		P_GET_PROPERTY(FStrProperty,Z_Param_TypeOfMatch);
		P_GET_PROPERTY(FStrProperty,Z_Param_LobbyPath);
		P_FINISH;
		P_NATIVE_BEGIN;
		P_THIS->MenuSetup(Z_Param_NumberOfPublicConncetions,Z_Param_TypeOfMatch,Z_Param_LobbyPath);
		P_NATIVE_END;
	}
	...
	struct Z_Construct_UFunction_UMenu_MenuSetup_Statics
	{
		...
		{
			int32 NumberOfPublicConncetions;
			FString TypeOfMatch;
			FString LobbyPath;
		};
		static const UECodeGen_Private::FIntPropertyParams NewProp_NumberOfPublicConncetions;
	...
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UFunction_UMenu_MenuSetup_Statics::NewProp_NumberOfPublicConncetions = { "NumberOfPublicConncetions", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(Menu_eventMenuSetup_Parms, NumberOfPublicConncetions), METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UMenu_MenuSetup_Statics::PropPointers[] = {
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UMenu_MenuSetup_Statics::NewProp_NumberOfPublicConncetions,
	...
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UMenu_MenuSetup_Statics::Function_MetaDataParams[] = {
		...
		{ "CPP_Default_NumberOfPublicConncetions", "4" },
	...
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UMenu_OnCreateSession_Statics::Function_MetaDataParams[] = {
		{ "Comment", "//\n// Callbacks for the custome delegates on the MultiplayerSessionsSubsystem\n// \n" },
		{ "ModuleRelativePath", "Public/Menu.h" },
		{ "ToolTip", "Callbacks for the custome delegates on the MultiplayerSessionsSubsystem" },
	};
#endif
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UMenu_Statics::FuncInfo[] = {
		...
		{ &Z_Construct_UFunction_UMenu_MenuSetup, "MenuSetup" }, // 1424471996
		{ &Z_Construct_UFunction_UMenu_OnCreateSession, "OnCreateSession" }, // 1907472940
	...
	struct Z_CompiledInDeferFile_FID_CodenameBreach_Plugins_MultiplayerSessions_Source_MultiplayerSessions_Public_Menu_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_CodenameBreach_Plugins_MultiplayerSessions_Source_MultiplayerSessions_Public_Menu_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMenu, UMenu::StaticClass, TEXT("UMenu"), &Z_Registration_Info_UClass_UMenu, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMenu), 149667110U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_CodenameBreach_Plugins_MultiplayerSessions_Source_MultiplayerSessions_Public_Menu_h_2180003587(TEXT("/Script/MultiplayerSessions"),
		Z_CompiledInDeferFile_FID_CodenameBreach_Plugins_MultiplayerSessions_Source_MultiplayerSessions_Public_Menu_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_CodenameBreach_Plugins_MultiplayerSessions_Source_MultiplayerSessions_Public_Menu_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
